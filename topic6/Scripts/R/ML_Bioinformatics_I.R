...
setwd("/home/changhyun/King's College London/ml_bioinfo_hi/topic6/Scripts/R")
raw_expression_data<-readRDS("/home/changhyun/King's College London/ml_bioinfo_hi/topic6/Data/expression_data.RDS")
phenotype_data<-readRDS("/home/changhyun/King's College London/ml_bioinfo_hi/topic6/Data/phenotype_data.RDS")
...
#AQ1: There are 249 principal components. The first two PCs explain 95% of total variance
...
# AQ4: 
# In both datasets, they are not perfectly balanced among case and control
...
# Q4: Once the model stops building, what is the optimum number of iterations returned?, 26
# What does happen after this iteration? slightly drop but, maintained to the similar level
...
RFE_results<-readRDS("/home/changhyun/King's College London/ml_bioinfo_hi/topic6/Data/RFE_results.RDS")
